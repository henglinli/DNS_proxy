...
void protobuf_AssignDesc_protocol_2eproto() {
  ...
  dns_record_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(dns_record));
  blocklist_descriptor_ = file->message_type(3);
  static const int blocklist_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(blocklist, host_),
  };
...
void protobuf_AddDesc_protocol_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "2\021.dns_proxy.ipv6_t\022\r\n\005alias\030\004 \003(\t\"\031\n\tbl"
    "ocklist\022\014\n\004host\030\001 \003(\t", 261);
...
#ifndef _MSC_VER
const int blocklist::kHostFieldNumber;
#endif  // !_MSC_VER
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_host:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->add_host()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->host(0).data(), this->host(0).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(10)) goto parse_host;
        if (input->ExpectAtEnd()) return true;
        break;
      }
...
void blocklist::SerializeWithCachedSizes(
  ...
  ::google::protobuf::internal::WireFormat::VerifyUTF8String(
    this->host(i).data(), this->host(i).length(),
    ::google::protobuf::internal::WireFormat::SERIALIZE);
    ::google::protobuf::internal::WireFormatLite::WriteString(
      1, this->host(i), output);
  }
...
::google::protobuf::uint8* blocklist::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->host_size(); i++) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
      ...
      ::google::protobuf::internal::WireFormat::SERIALIZE);
    target = ::google::protobuf::internal::WireFormatLite::
      WriteStringToArray(1, this->host(i), target);
  }
